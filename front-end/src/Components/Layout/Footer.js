                ...
                <section id="contact-us" className="section container pb-5" >
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-7 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div className="row text-center mt-1 wow fadeInUp" data-wow-delay="0.2s">
                                <div className="col-md-4" >
                                    <a style={{ backgroundColor: "#4285F4" }} className="mb-2 btn-floating "><i className="fas fa-map-marker-alt"></i></a>
                                    <p>Giza Governorate, October</p>
                                    <p>Egypt</p>
                                </div>
                                <div className="col-md-4">
                                    <a style={{ backgroundColor: "#4285F4" }} className="mb-2 btn-floating"><i className="fas fa-envelope"></i></a>
                                    <p>ieee@zewailcity.edu.eg</p>
                                </div>
                                <div className="col-md-4">
                                    <a style={{ backgroundColor: "#4285F4" }} className="mb-2 btn-floating "><i className="fas fa-phone"></i></a>
                                    <p>+20 238540400</p>
