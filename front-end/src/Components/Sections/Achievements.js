...
const AchievementsData = [
	{
		id: 1,
		img: 'https://res.cloudinary.com/ieeezc/image/upload/v1600273429/ac1_dvz4ur.png',
		title: 'IEEE Magazine',
		text:
	...
	{
		id: 2,
		img: 'https://res.cloudinary.com/ieeezc/image/upload/v1600273431/ac2_xdhsrl.jpg',
		title: 'E-Academy',
		text:
	...
	{
		id: 3,
		img: 'https://res.cloudinary.com/ieeezc/image/upload/v1600273434/ac3_gb1bfz.jpg',
	...
	{
		id: 4,
		img: 'https://res.cloudinary.com/ieeezc/image/upload/v1600273437/ac4_e0wcgt.jpg',
		...
		<>
			<div style={{ backgroundColor: '#F3F3F5' }} id='achievements'>
				...
				{height >= 600 && width >= 1020 ? (
					<h1 className='display-1 mt-5 text-center wow fadeInUp' data-wow-delay='0.2s'>
						Achievements
					</h1>
				) : null}
				...
				{height >= 568 && height < 1366 && width >= 320 && width < 657 ? (
					<h1 className='display-4 mt-5 text-center wow fadeInUp' data-wow-delay='0.2s'>
						Achievements
					</h1>
				) : null}
