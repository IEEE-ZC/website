...
const Intro = ({ IntroProps: { Slogan } }) => {
	return (
		<section style={{ height: '100vh' }} id='home'>
			...
			>
				<source
					src='https://res.cloudinary.com/ieeezc/video/upload/v1600273256/Intro_video_2_1_kug0gh_fiorfy.mp4'
					type='video/mp4'
				/>
			</video>
					...
					<div className='row pt-5 mt-3'>
						<div className='col-md-12 white-text text-center smooth-scroll'>
							<div className='white-text text-center wow fadeInUp'>
								<h3 className='display-1 font-weight-bold text-uppercase'>
									IEEE| Zewail City
								</h3>
								...
								<Link
									...
									smooth={true}
									duration={1000}
									className='btn btn-outline-white btn-rounded wow fadeInUp'
									data-wow-delay='0.2s'
									href='#about'
									data-offset='100'
								>
